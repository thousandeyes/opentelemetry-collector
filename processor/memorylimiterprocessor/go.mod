module github.com/thousandeyes/opentelemetry-collector/processor/memorylimiterprocessor
...
replace github.com/thousandeyes/opentelemetry-collector/processor => ../
