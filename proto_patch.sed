s+go.opentelemetry.io/proto/otlp/+github.com/thousandeyes/opentelemetry-collector/pdata/internal/data/protogen/+g
...
s+bytes trace_id = \(.*\);+bytes trace_id = \1\
  ...
  (gogoproto.customtype) = "github.com/thousandeyes/opentelemetry-collector/pdata/internal/data.TraceID"\
  ];+g
...
s+bytes \(.*span_id\) = \(.*\);+bytes \1 = \2\
  ...
  (gogoproto.nullable) = false,\
  (gogoproto.customtype) = "github.com/thousandeyes/opentelemetry-collector/pdata/internal/data.SpanID"\
  ];+g
